...
:::: {.columns style="display: flex; align-items: flex-end; text-align:center; margin-bottom: 2em;"}

::: {.column}
![`nanoGPT`](./assets/car.png){#fig-nanogpt style="max-height: 200px"}
:::

::: {.column}
![`wordplay`](./assets/robot.png){#fig-wordplay style="max-height: 256px"}
:::
