...
def load_and_save_dataset(name: str):
    dataset = load_dataset(name)

    # owt by default only contains the 'train' split, so create a test split
    # split_dataset = dataset["train"].train_test_split(test_size=0.1,
    # seed=2357, shuffle=True) split_dataset['val'] = split_dataset.pop('test')
    ...
    def process(example):
        ...
        # note: I think eot should be prepended not appended... hmm.
        # it's called "eot" though...
